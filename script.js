...
(() => {
  ...
  // Можно кликать прямо по персонажу — кнопка «ТЫК» остаётся как дополнительная зона клика.
  ui.character.style.cursor='pointer';
  ui.character.addEventListener('pointerdown',e=>{e.preventDefault();doClick(e.clientX,e.clientY)});
